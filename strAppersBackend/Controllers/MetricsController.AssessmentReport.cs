...
public partial class MetricsController
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Deliberately unfiltered by Metrics.Required: the report shows what was actually assessed.
        // Enablement decides what gets collected, not what a past collection is allowed to say, so
